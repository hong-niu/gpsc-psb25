...
def main_simul_2(tune = False, visualize=True, seeds=1):
    ...
    for seed in range(14, 14+seeds):
        ...
        data = utils.random_scramble(data, num_clust=4, save_random=True)
        ...
        data_out = utils.permute_clust(data=data_out, clustering='new_clust', clust1=1, clust2=4)
        data_out = utils.permute_clust(data=data_out, clustering='new_clust', clust1=3, clust2=4)
